...
class DataModuleClass(pl.LightningDataModule):
    ...
    def prepare_data(self):
        self.column_train=MyDataset("Train0",self.nbSamplesTrain, self.in_db)
        self.column_val=MyDataset("Val0",self.nbSamplesVal, self.in_db)
...
if VERIF:
    ...
    if CROISE:
        TRAINNOISEPATH=os.path.join("..", "..", "Dataset","Train0","Noisy","X_all.npy") #noisy spectro train
        TRAINCLEANPATH=os.path.join("..", "..", "Dataset", "Train0","Clean","X_clean_all.npy") #clean spectro train
